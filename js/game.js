    ...
    if (event.key === 'Escape') {
        if (gameRunning) {
            if (!paused) {
                ...
                document.getElementById('btn-div').style.display = 'block';
                document.getElementById('btn-div').style.pointerEvents = 'auto';
                console.log(document.getElementById('btn-div').style.display + " continuar")
                console.log(document.getElementById('btn-div').style.pointerEvents + " pcontinuar")
                drawImageOverCanvas()
            } else {
                paused = false;
                document.getElementById('btn-div').textContent = 'Pausar';
                document.getElementById('btn-div').style.display = 'none';
                document.getElementById('btn-div').style.pointerEvents = 'none';
                console.log(document.getElementById('btn-div').style.display + " pausar")
                decreaseTimer()
                animate()
            }
        }
